...
void LogNormalOptimizer::updateGradient(const Eigen::VectorXd& x, const PointProcessDataset& dataset, Eigen::VectorXd& gradient){
    // Sigma = x[0]
    // Theta = x.segment(1,x.size() - 1)
...
void LogNormalOptimizer::updateGradientRc(const Eigen::VectorXd& x, const PointProcessDataset& dataset, Eigen::VectorXd& gradientRc){
    // Sigma = x[0]
    // Theta = x.segment(1,x.size() - 1)
...
void LogNormalOptimizer::updateHessian(const Eigen::VectorXd& x, const PointProcessDataset& dataset, Eigen::MatrixXd& hessian){
    // Sigma = x[0]
    // Theta = x.segment(1,x.size() - 1)
    // Mus = (dataset.xn * x.segment(1,x.size() - 1))
...
double LogNormalOptimizer::computePDF(const Eigen::VectorXd& x, const PointProcessDataset& dataset){
    // Sigma = x[0]
    // Theta = x.segment(1,x.size() - 1)
    // rcMu = x.segment(1,x.size() - 1).dot(dataset.xt)
    return exp(
...
double LogNormalOptimizer::computeCDF(const Eigen::VectorXd& x, const PointProcessDataset& dataset){
    // Sigma = x[0]
    // Theta = x.segment(1,x.size() - 1)
    // rcMu = x.segment(1,x.size() - 1).dot(dataset.xt)
    boost::math::normal norm;
...
double LogNormalOptimizer::computeLikel(const Eigen::VectorXd& x, const PointProcessDataset& dataset){
    // Sigma = x[0]
    // Theta = x.segment(1,x.size() - 1)
    // Mus = (dataset.xn * x.segment(1,x.size() - 1))
...
unsigned int LogNormalOptimizer::getNumberOfAdditionalParams(){
