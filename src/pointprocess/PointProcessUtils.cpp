...
namespace pp {
    namespace utils {
        ...
        PipelineSetup
        getPipelineSetup(const std::vector<double> &events, bool rc, bool hasTheta0_, unsigned char AR_ORDER_,
            ...
            return PipelineSetup(delta, events, rc, hasTheta0_, AR_ORDER_, last_event_index, bins, bins_in_window, maxIter,
                    weightsProducer);
        }
