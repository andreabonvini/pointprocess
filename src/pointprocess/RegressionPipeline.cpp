...
// LCOV_EXCL_START
RegressionPipeline::RegressionPipeline(pointprocess::Distributions distribution,
...
// TODO: test!
// LCOV_EXCL_START
pointprocess::Result RegressionPipeline::fullRegression(const std::vector<double>& events_times,
                                                        ...
                                                        double       alpha          = 0.0)
{
    ...
    std::transform(events_times.begin(),
                   events_times.end(),
                   events.begin(),
                   [&](auto& value) { return value - t0; });

    auto pipelineSetup = pointprocess::utils::getPipelineSetup(events,
                                                               hasTheta0,
                                                               AR_ORDER,
                                                               windowLength,
                                                               delta,
